...
# Direcciones realmente insuficientes para geocodificar con precisión.
SKIP_EXACT_VALUES = {
    "punto confirmado en mapa, estación central, región metropolitana",
...
def is_too_generic(address: str) -> bool:
    ...
    if len(normalized) < 12:
        return True
    if normalized in SKIP_EXACT_VALUES:
        return True
